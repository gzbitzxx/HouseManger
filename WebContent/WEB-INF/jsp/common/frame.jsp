	...
	<div id="wrapper">
			...
			<ul class="nav" id="side-menu">
					...
					<div class="dropdown profile-element">
						...
						<ul class="dropdown-menu animated fadeInRight m-t-xs">
							<c:if test="${user.type=='0'}">
								<li><a class="J_menuItem" href="/HouseManager/user/toInfo">个人资料</a></li>
							</c:if>
							<li><a href="/HouseManager/user/loginOut">安全退出</a></li>
						</ul>
					</div>
				...
				<c:if test="${user.type=='1'}">
					<li><a class="J_menuItem" href="user/toList"><i
						...
						class="J_menuItem" href="complaint/toList2"><i
						...
						href="repair/toList2"><i class="fa fa-user"></i>维修列表</a> <a
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row content-tabs">
				...
				<a href="/HouseManager/user/loginOut"
