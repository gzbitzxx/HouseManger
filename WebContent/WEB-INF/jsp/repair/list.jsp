				...
				.GM({
					...
					columnData : [
							...
							},
							{
								...
								text : '操作',
								template : function(action, rowObject) {
									return '<a style="color: #FFF;background: #337ab7;display: inline-block;padding: 4px 10px;border-radius: 4px;" href="javascript:;" onclick="lookInfo(\''
											+ rowObject.id + '\')">查看</a>';
								}
							} ]
		...
		<div class="col-md-1">
			<div class="form-group">
				<button type="button" data-toggle="modal" data-target="#myModal"
					class="btn">
					<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>我要报修
				</button>
			</div>
		</div>
	</div>
				...
				<form id="data">
					<div class="modal-body">
							<div class="col-lg-12">
								<div class="form-group" lang="content">
									<label for="phone">维修名称：</label> <input type="text"
										class="form-control" name="name1" id="name1" placeholder="内容"
										data-val="true" data-val-required="请填写 &#39;维修名称&#39;。">
									<span class="field-validation-error" data-valmsg-for="name1"
										data-valmsg-replace="true"></span>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group" lang="content">
									<label for="phone">内容：</label> <input type="textarea"
										class="form-control" name="content1" id="content1"
										placeholder="内容" data-val="true"
										data-val-required="请填写 &#39;内容&#39;。"> 
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group" lang="phone">
									<label for="phone">联系电话：</label> <input type="text"
										class="form-control" name="phone1" id="phone1" placeholder="内容"
										data-val="true" data-val-required="请填写 &#39;联系电话&#39;。">
							...
							<div class="col-lg-12">
								<div class="form-group" lang="content">
									<label for="phone">费用：</label> <input type="textarea"
										class="form-control" name="money1" id="money1" placeholder="费用"
										data-val="true" data-val-required="请填写 &#39;费用&#39;。">
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group" lang="remarks">
									<label for="phone">备注：</label> <input type="textarea"
										class="form-control" name="remarks1" id="remarks1"
										placeholder="备注" data-val="true"
										data-val-required="请填写 &#39;备注&#39;。">
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group" lang="content">
									<label for="phone">图片上传：</label> <input type="textarea"
										class="form-control" name="pictures1" id="pictures1"
										placeholder="图片上传" data-val="true"
										data-val-required="请填写 &#39;图片上传&#39;。">
								</div>
							</div>
						</div>
						<div class="modal-footer">
